sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("int/offlinelist/OfflineList/app", ".html");
		...
		return Opa5.extend("int.offlinelist.OfflineList.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["int/offlinelist/OfflineList/localService/mockserver"], function (mockserver) {
